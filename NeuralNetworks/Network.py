...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        ...
        This works by sampling mini_batches of the training data and computing the right weights 
        and biases to enhance accuracy. training_data is a list of tuples (x,y) representing the 
        training inputs and corresponding outputs. epochs, mini_batch_size and test_data are 
